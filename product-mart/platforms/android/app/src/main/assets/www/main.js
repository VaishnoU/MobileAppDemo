...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, loadingController, api) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.api.getRequest("/getproduct")
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            _communicator_service__WEBPACK_IMPORTED_MODULE_5__["CommunicatorService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _communicator_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./communicator.service */ "./src/app/communicator.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_12__["BrowserAnimationsModule"]],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
                _communicator_service__WEBPACK_IMPORTED_MODULE_9__["CommunicatorService"],
...
var CommunicatorService = /** @class */ (function () {
    function CommunicatorService(httpClient) {
        this.httpClient = httpClient;
        this.ws_url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].API_URL;
    }
    CommunicatorService.prototype.getRequest = function (url, header, params) {
        return this.httpClient.get(this.ws_url + url, { headers: header, params: params });
    };
    CommunicatorService.prototype.postRequest = function (url, modal, header, params) {
        return this.httpClient.post(this.ws_url + url, modal, { headers: header, params: params });
    };
    CommunicatorService.prototype.putRequest = function (url, modal, header, params) {
        return this.httpClient.put(this.ws_url + url, modal, { headers: header, params: params });
    };
    CommunicatorService.prototype.deleteRequest = function (url, header, params) {
        return this.httpClient.delete(this.ws_url + url, { headers: header, params: params });
    };
    CommunicatorService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var environment = {
    production: false,
    API_URL: "http://localhost:8080/products/v1"
};
/*
...
module.exports = __webpack_require__(/*! D:\Workspace\ProductMart\product-mart\src\main.ts */"./src/main.ts");
